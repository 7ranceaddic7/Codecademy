...
# =============================================================== #
#
# PERSONAL $HOME/.bashrc FILE for Scott A. McCarthy
#
# Last modified: 
#
...
#
#  The choice of colors is for a shell with a dark background.
#
#  P.S. Don't forget to permit execution, chmod +x
# =============================================================== #
...
export HISTTIMEFORMAT; HISTTIMEFORMAT="$(echo -e "${BCyan}")[%d/%m %H:%M:%S]$(echo -e "${NC}")"
...
complete -f -o default -X '!*.@(mp?(e)g|MP?(E)G|wma|avi|AVI|asf|vob|VOB|bin|dat|vcd|ps|pes| '\
'fli|viv|rm|ram|yuv|mov|MOV|qt|QT|wmv|mp3|MP3|ogg|OGG|ogm|OGM|mp4|MP4|wav|WAV|asx|ASX)' xine
...
_make()
{
    ...
    #  If we have a partial word to complete, restrict completions to matches of that word.
